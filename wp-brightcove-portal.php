...
Plugin URI: http://svhosting.biz/wp-plugins/wp-brightcove-portal.html
...
function wpBrightcovePortalMenu() {
   ...
   add_menu_page('WP Brightcove Portal', 'Brightcove Portal', 'manage_options', 'wp-brightcove-portal', 'wpBrightcovePortalvideos', get_option('siteurl').'/wp-content/plugins/wp-brightcove-portal/img/menuIcon.png '  );
